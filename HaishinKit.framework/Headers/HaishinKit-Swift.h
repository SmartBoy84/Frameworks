...
SWIFT_CLASS("_TtC10HaishinKit24DisplayLinkChoreographer")
@interface DisplayLinkChoreographer : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10HaishinKit11IOAudioUnit")
@interface IOAudioUnit : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface IOAudioUnit (SWIFT_EXTENSION(HaishinKit)) <AVCaptureAudioDataOutputSampleBufferDelegate>
...
SWIFT_CLASS("_TtC10HaishinKit21IOUIScreenCaptureUnit")
@interface IOUIScreenCaptureUnit : NSObject
...
SWIFT_CLASS("_TtC10HaishinKit11IOVideoUnit")
@interface IOVideoUnit : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface IOVideoUnit (SWIFT_EXTENSION(HaishinKit)) <AVCaptureVideoDataOutputSampleBufferDelegate>
